...
class evoting_reset extends \core\event\base{
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('eventevotingreset', 'mod_evoting');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'evoting', 'reset evoting', $logurl, $this->contextinstanceid);
    }
